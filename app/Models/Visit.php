...
class Visit extends Model
{
    ...
    public $table="visits";
    protected $fillable = ['user_id','employee_id','user_client_id','client_address_id','description','status','current_contract_end_date','visit_date','latitude','longitude','follow_up_date','images'];
