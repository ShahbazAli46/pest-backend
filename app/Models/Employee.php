...
class Employee extends Model
{
    ...
    protected $fillable = ['user_id','role_id','profile_image','phone_number','target','profession','relative_name','relation','emergency_contact','basic_salary','allowance','other','total_salary','commission_per','hold_salary','country','branch_id', 'joining_date', 'remaining_off_days','contract_target'];
