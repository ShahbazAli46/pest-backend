...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('employee_advance_payments', function (Blueprint $table) {
            $table->decimal('vat_per', 15, 2)->default(0.00)->after('advance_payment');
            $table->decimal('vat_amount', 15, 2)->default(0.00)->after('vat_per');
            $table->decimal('adv_pay_with_vat', 15, 2)->default(0.00)->after('vat_amount');
    ...
    public function down(): void
    {
        Schema::table('employee_advance_payments', function (Blueprint $table) {
            ...
            $table->dropColumn('adv_pay_with_vat');
        });
    }
};
